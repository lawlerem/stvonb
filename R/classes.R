#' A list of classes in the stvonb package.
#'
#' To see documentation for a particular class, load the package and run e.g.
#'   class?stvonb. To see a list of all methods available for a specific class,
#'   see the help page for that class or run e.g.
#'   \code{methods(class="stvonb")}.
#'
#' @section Classes:
#' \itemize{
#'   \item dag
...
#' An S4 class to hold settings for a stvonb model
#'
...
#' An S4 class to hold process parameters for a stvonb model.
#'
...
#' An S4 class to hold the process information for a stvonb model.
#'
...
#' An S4 class to hold observation parameters for a stvonb model.
#'
...
#' An S4 class to hold the observation information for a stvonb model.
#'
...
#' An S4 class to hold optimization tracing for a stvonb model
#'
...
#' An S4 class describing a stvonb model.
#'
...
#'
#' @seealso process_parameters_class, observation_parameters_class, stvonb_class
#'

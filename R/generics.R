...
setGeneric(
  name = "stvonb_fit",
  def = function(object, ...) standardGeneric("stvonb_fit")
)
...
setGeneric(
  name = "stvonb_predict",
  def = function(x, new_data, ...) standardGeneric("stvonb_predict")
)
...
#' @export
setGeneric(
  name = "stvonb_simulate",
  def = function(object, ...) standardGeneric("stvonb_simulate")
)
...
setGeneric(
  name = "stvonb_update",
  def = function(x, y) standardGeneric("stvonb_update")
)
